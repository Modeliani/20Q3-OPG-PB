...
package pkg20q3.opg.pb.fhdw.utilities;

import java.io.*;
import java.util.*;

/**
 * <code>Console provides a set of methods to support ease of console reading and printing. 
 * <br>Printing is supported by static functions printMessage & printErrorMessage
 * <br>Reading is supported by a set of static read methods. Common to all read methods is:
 * <br>- every read method prints a prompt & reads of complete input line 
 * <br>- every read method checks input to be IN line with format expectations (if any)
 <br>- error message & repeated input request are generated if input is not IN line with format expectations (if any)
 * 
...
public class Console {
	 ...
	 * 
	 * @param prompt to be displayed + choice options (strings)
